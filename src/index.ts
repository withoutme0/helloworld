...
export const filmizlevipAddon = createWorkerAddon({
  id: "diziay.me",
  name: "diziay",
  version: "0.0.1",
...
filmizlevipAddon.registerActionHandler("directory", directoryHandler);
filmizlevipAddon.registerActionHandler("item", itemHandler);
